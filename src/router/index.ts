...
const router = createRouter({
  history: createWebHistory('/mahjong-score'), // 기본 경로 지정
  routes,
})

router.beforeEach((to, _from, next) => {
  const locale=(to.params.locale as 'ko');
  ...
  const baseUrl = 'https://he1fire.github.io/mahjong-score';
